...
int main()
{
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		model = glm::translate(model, glm::vec3(triOffset, triOffset, 0.0f));	//just multiplies model matrix with a “translation matrix” and dot produc it to vec3
